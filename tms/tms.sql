...
(2, 'privacy', '										<span style=\"color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; font-size: 14px; text-align: justify;\">Our Tourism Management System values your privacy and is committed to protecting your personal information. We collect data such as your name, contact details, travel preferences, and payment information to process bookings and improve our services. This information is used to manage tours, provide customer support, and enhance user experience. We do not sell your data but may share it with trusted third parties like hotels or transport providers to fulfill your requests. All data is secured with industry-standard encryption and security measures. You have full rights to access, modify, or delete your personal data at any time. We also use cookies to personalize content and analyze traffic, which can be managed through your browser settings. By using our system, you consent to our data practices. Any updates to this privacy policy will be posted here. For any questions or concerns, feel free to contact our support team.</span>\r\n										'),
...
(11, 'contact', '																				<span style=\"color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; font-size: 14px; text-align: justify;\">Address------J-890 Dwarka House Jaipur,Rajasthan-110096</span>');
